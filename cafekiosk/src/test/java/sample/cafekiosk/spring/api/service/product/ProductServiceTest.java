...
class ProductServiceTest {
  ...
  @DisplayName("신규 상품을 등록할 때, 상품이 하나도 없는 경우 신규 상품을 등록하면 상품번호는 001이다.")
  @Test
  void createProductWhenProductsIsEmpty() {
    ...
    assertThat(productResponse)
        .extracting("productNumber", "name", "productType", "sellingStatus", "price")
        .containsExactly("001", "카푸치노", HANDMADE, SELLING, 5000);
  ...
  void createProduct() {
    ...
    assertThat(productResponse)
        .extracting("productNumber", "name", "productType", "sellingStatus", "price")
        .containsExactly("002", "카푸치노", HANDMADE, SELLING, 5000);
